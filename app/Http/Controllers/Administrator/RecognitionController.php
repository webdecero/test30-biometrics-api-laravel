...
class RecognitionController extends AbstractCoreController
{
    ...
    public function __construct(Request $request)
    {
        ...
        $this->initConfig('administrator.recognition');
    }
    ...
    function store(Request $request)
    {
        ...
        try {
            ...
            if (!empty($validator) && $validator->fails())
                return $this->sendError('error_validation', $validator->errors()->all(), 422);
            ...
            if (!empty($record))
                return $this->sendError('error_validation', "The registry has already been created.", 422);
    ...
    public function reset(Request $request, $id)
    {
        try {
            ...
            //TODO: debe solicitar el reset (borrar usuarios y configuracion) del dispositivo recognition y volver a sincronizar registirando nuevamente los usuarios


            // $model->model = $input['modelName'];
