...
class GroupController extends AbstractCoreController
{
    ...
    public function __construct(Request $request)
    {
        ...
        $this->initConfig('administrator.group');
    }
    ...
    function store(Request $request)
    {
        ...
        try {
            ...
            if (!empty($record)) return $this->sendError('error_validation', "The group has already been created.", 422);
    ...
    public function destroy($id)
    {
        try {
            ...
            /**
             * TODO: hacer validaciones para borrado de grupo
