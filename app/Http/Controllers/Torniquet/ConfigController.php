...
class ConfigController extends AbstractCoreController
{
    ...
    protected $prefixTerminal = TerminalType::TORNIQUET->value;
    ...
    function setup(Request $request)
    {
        ...
        try {
            ...
            $cf = [
                "name" => "Terminal Biometrics Torniquete",
            ...
            $cf["terminal"] = [
                "id" => $terminal->id,
                "key" => $terminal->key,
                "type" => $terminal->key,//TODO: cambiar por tipo de terminal
                "name" => $terminal->name,
                "status" => $terminal->status,
                "deviceId" => $terminal->deviceId??'',
                "modelName" =>$terminal->modelNameName??'',//TODO: cambiar por tipo de terminal
                "hostname" => $terminal->hostname??'',//TODO: cambiar por tipo de terminal
